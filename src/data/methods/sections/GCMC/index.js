...
const GCMC = {
  ...
  content: (
    ...
    <div style={{
      ...
      <div style={{
        ...
        <br /><br />
				...
				PubMed</a>]  
				[<a href="pdf/Im_Seefeld_Roux_2000.pdf">pdf</a>]
        <br /><br />
				...
				PubMed</a>]  
				[<a href="pdf/Im_Roux_JMB_2002b.pdf">pdf</a>]
    ...
    <b>Downloads:</b>
    <ul>
      <li><b><a href="./gcmc-bd.tar.gz"> GCMC/BD program with examples and documentation </a></b></li>
    </ul>
    </>
  ),
};
