...
const SAXS = {
  ...
  content: (
    ...
    <b>Downloads:</b>
    <ul><b>
      <li><a href={withPrefix("/resources/downloads/SAXS/Fast-SAXS.v1.tar.gz")} download>Fast-SAXS for proteins</a></li>
    </b></ul>
    </>
  ),
