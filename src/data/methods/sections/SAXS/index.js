...
const SAXS = {
  ...
  content: (
    ...
    <b>Downloads:</b>
    <ul><b>
      <li><a href="Fast-SAXS.v1.tar.gz">Fast-SAXS for proteins</a></li>
    </b></ul>
    </>
  ),
