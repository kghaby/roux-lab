...
const SBP = {
  ...
  content: (
    ...
    <p>
      ...
      a large hard sphere (<a href={withPrefix("/resources/publications/beglov_jcp_1994.pdf")}>Beglov and Roux, 1994</a>). 
    </p>
    <p>
      ...
      (<a href={withPrefix("/resources/publications/Im_Berneche_Roux_gsbp2001.pdf")}>Im et al, 2001</a>).
    ...
    <p>
      ...
      (<a href={withPrefix("/resources/publications/deng_jcp2008.pdf")}>Deng and Roux, 2008</a>).
    </p>
    <p>
    ...
    <b>Downloads:</b>
    <ul><b>
      <li><a href={withPrefix("/resources/downloads/SBP/ssbp.tar.gz")} download> Electrostatic solvation free energy of alanine dipeptide in water using SSBP </a></li>
      <li><a href={withPrefix("/resources/downloads/SBP/gsbp_june2005.tar.gz")} download> Electrostatic free energy of aspartic acid in aspartyl-t-RNA synthase using GSBP</a></li>
      <li><a href={withPrefix("/resources/downloads/SBP/gcmc_june2005.tar.gz")} download> Basic GCMC examples with water</a></li>
      <li><a href={withPrefix("/resources/downloads/FEP/fep_tutorial.tar.gz")} download> Absolute binding free energy calculations with GSBP and GCMC.</a></li>
    </b></ul>
    </>
  ),
