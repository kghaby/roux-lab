...
const SBP = {
  ...
  content: (
    ...
    <p>
      ...
      a large hard sphere (<a href="../../pdf/beglov_jcp_1994.pdf">Beglov and Roux, 1994</a>). 
    </p>
    <p>
      ...
      (<a href="../../pdf/Im_Berneche_Roux_gsbp2001.pdf">Im et al, 2001</a>).
    ...
    <p>
      ...
      (<a href="../../pdf/deng_jcp2008.pdf">Deng and Roux, 2008</a>).
    </p>
    <p>
    ...
    <b>Downloads:</b>
    <ul><b>
      <li><a href="ssbp.tar.gz"> Electrostatic solvation free energy of alanine dipeptide in water using SSBP </a></li>
      <li><a href="gsbp_june2005.tar.gz"> Electrostatic free energy of aspartic acid in aspartyl-t-RNA synthase using GSBP</a></li>
      <li><a href="gcmc_june2005.tar.gz"> Basic GCMC examples with water</a></li>
      <li><a href="../FEP/fep_tutorial.tar.gz"> Absolute binding free energy calculations with GSBP and GCMC.</a></li>
    </b></ul>
    </>
  ),
