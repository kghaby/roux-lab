...
const Cavity = {
  title: "7lectrostatics of the KcsA Channel",
  media: (
    <StaticImage
  ...
  description: (
    <>
      <p>
      Continuum electrostatics calculations based on the finite-difference Poisson-uned" to be preferably occupied by a monovalent cation.
      </p>
