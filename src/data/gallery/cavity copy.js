...
const Cavity = {
  title: "1Electrostatics of the KcsA Channel",
  media: (
    <StaticImage
  ...
  description: (
    <>
      <p>
      Coum electrostatics calculations based on the finite-difference Poisson-Boltzman equation are used to show that the cavity and 
