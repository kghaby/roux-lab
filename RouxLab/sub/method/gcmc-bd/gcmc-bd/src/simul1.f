...
c-------------------------------------------------------------------------------
      ...
      integer   prob2(dtype,0:50)
      integer   prob3(dtype,0:datom)     ! datom=500
      integer   prob4(-50:50)
      integer   irmax
      real*8    gr(dtype,1000),rho(dtype,1000),sgr(dtype)
      real*8    sw1,dsw1
      real*8    r 
      real*8    sw2,dsw2
...
c ion pairing S frequency
      integer   nion1(dtype,1000),sp1p2(dtype,10,10)
      integer   npair1(dtype,1000),npair2(dtype,1000)
      integer   npair3(dtype,1000),npair4(dtype,1000)
      real*8    s1,s2

c energy profiles
      integer  nion2(dtype,1000)
      real*8   etmp,etot(dtype,1000),eion(dtype,1000)
      real*8   erf(dtype,1000),esf(dtype,1000),egvdw(dtype,1000)
      real*8   e2tot(dtype,1000),e2ion(dtype,1000)
      real*8   e2rf(dtype,1000),e2sf(dtype,1000),e2gvdw(dtype,1000)
